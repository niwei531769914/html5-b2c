    ...
    requirejs: {
      ...
      registerhelp: {
        options: {
          ...
          preserveLicenseComments: false,
          baseUrl: './app/',
          out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.registerhelp.js',
          mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
          paths: {
            'moment': '../bower_components/momentjs/min/moment.min',
            'fastclick': '../bower_components/fastclick/lib/fastclick'
          ...
          include: [
            'lehu.helpers',
            'lehu.h5.page.registerhelp'
          ],
          insertRequire: ['lehu.h5.page.registerhelp']
        }
      },
      userhelp: {
        options: {
          ...
          preserveLicenseComments: false,
          baseUrl: './app/',
          out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.userhelp.js',
          mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
          paths: {
            'moment': '../bower_components/momentjs/min/moment.min',
            'fastclick': '../bower_components/fastclick/lib/fastclick'
          ...
          include: [
            'lehu.helpers',
            'lehu.h5.page.userhelp'
          ],
          insertRequire: ['lehu.h5.page.userhelp']
        }
      },
      headlines: {
            options: {
                ...
                preserveLicenseComments: false,
                baseUrl: './app/',
                out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.headlines.js',
                mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
                paths: {
                    'moment': '../bower_components/momentjs/min/moment.min',
                    'fastclick': '../bower_components/fastclick/lib/fastclick'
                ...
                include: [
                    'lehu.helpers',
                    'lehu.h5.page.headlines'
                ],
                insertRequire: ['lehu.h5.page.headlines']
            }
        },
      stores: {
            options: {
                ...
                preserveLicenseComments: false,
                baseUrl: './app/',
                out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.stores.js',
                mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
                paths: {
                    'moment': '../bower_components/momentjs/min/moment.min',
                    'fastclick': '../bower_components/fastclick/lib/fastclick'
                ...
                insertRequire: ['lehu.h5.page.stores']
            }
        },
      graphicdetails: {
            options: {
                ...
                preserveLicenseComments: false,
                baseUrl: './app/',
                out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.graphicdetails.js',
                mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
                paths: {
                    'moment': '../bower_components/momentjs/min/moment.min',
                    'fastclick': '../bower_components/fastclick/lib/fastclick'
      ...
      coupon: {
        options: {
          ...
          preserveLicenseComments: false,
          baseUrl: './app/',
          out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.coupon.js',
          mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
          paths: {
            'moment': '../bower_components/momentjs/min/moment.min',
            'fastclick': '../bower_components/fastclick/lib/fastclick'
      ...
      timeLimit: {
            options: {
                ...
                preserveLicenseComments: false,
                baseUrl: './app/',
                out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.timeLimit.js',
                mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
                paths: {
                    'moment': '../bower_components/momentjs/min/moment.min',
                    'fastclick': '../bower_components/fastclick/lib/fastclick'
                ...
                include: [
                    'lehu.helpers',
                    'lehu.h5.page.timeLimit'
                ],
                insertRequire: ['lehu.h5.page.timeLimit']
            }
        },
      servers: {
            options: {
                ...
                preserveLicenseComments: false,
                baseUrl: './app/',
                out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.servers.js',
                mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
                paths: {
                    'moment': '../bower_components/momentjs/min/moment.min',
                    'fastclick': '../bower_components/fastclick/lib/fastclick'
      ...
      activitydonatelist: {
        ...
        orderlist: {
            options: {
                ...
                preserveLicenseComments: false,
                baseUrl: './app/',
                out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.orderlist.js',
                mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
                paths: {
                    'moment': '../bower_components/momentjs/min/moment.min',
                    'fastclick': '../bower_components/fastclick/lib/fastclick'
                ...
                include: [
                    'lehu.helpers',
                    'lehu.h5.page.orderlist'
                ],
                insertRequire: ['lehu.h5.page.orderlist']
            }
        },
        orderDetails: {
            options: {
                ...
                preserveLicenseComments: false,
                baseUrl: './app/',
                out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.orderDetails.js',
                mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
                paths: {
                    'moment': '../bower_components/momentjs/min/moment.min',
                    'fastclick': '../bower_components/fastclick/lib/fastclick'
        ...
        activitysummer: {
            options: {
                ...
                preserveLicenseComments: false,
                baseUrl: './app/',
                out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.activitysummer.js',
                mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
                paths: {
                    'moment': '../bower_components/momentjs/min/moment.min',
                    'fastclick': '../bower_components/fastclick/lib/fastclick'
        ...
        activity1: {
            options: {
                ...
                preserveLicenseComments: false,
                baseUrl: './app/',
                out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.activity1.js',
                mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
                paths: {
                    'moment': '../bower_components/momentjs/min/moment.min',
                    'fastclick': '../bower_components/fastclick/lib/fastclick'
...
>>>>>>> 3c12fdc9b9389a5044646cbca1269486dc16fe35
};